...
contract NKCNToken is ERC721Full, Governance {
    // for minters
    mapping(address => bool) public _minters;
    uint256 private constant MAX_SUPPLY = 108;


    constructor() public ERC721Full("NKCN", "NKCN") {
        _setBaseURI("https://nftkkswap.com/nkcn-token/");
    }
